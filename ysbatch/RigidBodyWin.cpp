...
void Register_classification(lua_State*L);
...
//{
	...
	//"analyze_motion2.lua",
	//"../Samples/classification/lua/motionClassification/");
//}
...
void RigidBodyWin::firstInit()
{
	   ...
	   if (g_argc==2 )
	   {
			   ...
			   releaseScript();
			   if (g_argv[1][0]='/')
					   loadScript( g_argv[1], g_argv[2]);
			   else
					   loadScript( defaultScriptFolder+g_argv[1], g_argv[2]);
	   }
}
