...
-- dcjo-surgery
--useCases.g2592_ipfrun.muscleModification =	false--true
--useCases.g2592_ipfrun.useAngleOffset = false
--useCases.g2592_ipfrun.maxAngleOffset = {hipRmax = vector3(20,5,5), hipLmax = vector3(20,5,5), kneeRmax = 30, kneeLmax = 30, ankleRmax = vector3(80, 20, 20), ankleLmax = vector3(80,20,20), mtpRmax = 70, mtpLmax = 70}
